...
export interface CampusInstitutionCardProps {
  institution: InstitutionSummary;
  className?: string;
}

export const CampusInstitutionCard: React.FC<CampusInstitutionCardProps> = ({
  institution,
  className,
}) => {
  ...
  return (
    <Link
      href={`/institutions/${institution.id}/departments`}
      className={cn(
